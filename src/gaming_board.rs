...
impl Board {
    ...
    pub fn create_board(
        ...
        for i in 1..self.width * self.height {
            let mut object = Objects::new(apple_preset, snake_preset, wall_preset, empty_preset);
            ...
            } else if height == 1 || height == self.height {
                object.wall();
                self.map.insert(i, object);
            } else {
                object.empty();
